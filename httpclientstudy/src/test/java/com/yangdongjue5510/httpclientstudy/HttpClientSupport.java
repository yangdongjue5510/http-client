...
/**
 * HttpClient 객체에 대한 설명을 담고 있는 클래스.
 */
public class HttpClientSupport {
    /**
     * HttpClient는 Builder를 통해 생성 가능하다.
    ...
    public static final HttpClient httpClient = HttpClient.newBuilder()
            ...
            // http 2.0에서만 적용되는 priority 설정할 수 있다.
            .priority(1)
     ...
     * 설정을 기본값으로 한 HttpClient를 쉽게 만들 수 있다.
      */
    public static final HttpClient defaultClient = HttpClient.newHttpClient();
}
